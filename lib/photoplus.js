...
(function() {
  define(['jquery', 'flight/lib/component', 'components/data/with_listing_media'], function($, defineComponent, withListingMedia) {
    ...
    photoPlus = function() {
      ...
      this.getPhotoPlusMedia = function(listingId) {
        return ListingMedia.get(listingId, (function(_this) {
          return function(media) {
            return _this.populateGallery(media);
          };
        })(this));
      };
      this.next = function() {
        var image;
        if (!this.galleryPopulated()) {
          this.trigger('uiWantsListingMedia', this.listingId);
        }
        image = this.current();
        if (image !== this.total()) {
